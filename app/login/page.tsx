    ...
    return (
        <section className="w-full h-full flex flex-col">
            <div className="mx-auto rounded-xl bg-slate-200 my-10 px-10 py-5">
                ...
                <div>
                    <button onClick={handleSubmit(signInWithCreds)} className="w-full px-6 py-3 flex items-center justify-center my-2 font-bold border-[1px] bg-violet-500 hover:bg-violet-600 text-white rounded-xl gap-3 ">
                        Login{" "}
                        <span>
                            <MdLogout size={20} />
                        </span>
